...
from shared.python.schemas import AutoFixIssuePlan, Analysis, CharterEvaluation
...
class AutoFixPlannerClient:
    ...
    async def plan(self, analysis: Analysis, charter: CharterEvaluation) -> AutoFixIssuePlan:
        input_data = {
        ...
        return AutoFixIssuePlan.model_validate_json(json_str)

    async def execute(self, repo_name: str, plan: AutoFixIssuePlan):
        created_issues = []
