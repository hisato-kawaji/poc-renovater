...
from agents.issue_planner import build_issue_planner_agent

from app.application.agents.runner import run_agent

class IssuePlannerClient:
    ...
    async def plan(self, analysis: Analysis, charter: CharterEvaluation) -> IssuePlan:
        ...
        json_str = await run_agent(self.deps, "issue-planner-agent", build_issue_planner_agent, str(input_data))
